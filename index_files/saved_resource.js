...
function t400_init(recid){
  ...
  el.find('.t400__submit').click(function() {
    ...
    $('.t544, .t477, .t532, .t764, .t418, .t774, .t480, .t686, .t599, .t570, .t554, .t650, .t351, .t353, .t341, .t385, .t226, .t404, .t412, .t552, .t279, .t384, .t229, .t456, .t268, .t334, .t121, .t517, .t545, .t518, .t744, .t778, .t604, .t774, .t694, .t230, .t609, .t688, .t670, .t592, .t740, .t762, .t827, .t829, .t498, .t539, .t422, .t347, .t801, .t842, .t843, .t849, .t850, .t851, .t856, .t858, .t859, .t860, .t728, .t738').trigger('displayChanged');
    setTimeout(function(){
      $('.t351, .t353, .t341, .t410, .t385, .t738').trigger('displayChanged');
    },50);
...
function t802_insta_drawItem(recid,username,item){
    ...
    if (emptyEl.length > 0) {
        ...
        emptyEl.wrap('<a href="'+item.link+'"></a>');
...
function t827_showOverlay(overlay, item) {
  ...
  if ($(window).width() >= 1024) {
    ...
    item.click(function() {
      if ($(this).find('.t827__overlay').css('display') == 'none') {
        overlay.css('display', 'none');
        $(this).find('.t827__overlay').css('display', 'block');
      } else {
        $(this).find('.t827__overlay').css('display', 'none');
      }
    });
  }
}
...
function t860_translateBlock(rec) {
  ...
  var colWrapHeight = rec.find('.t860__inner-col').height();
